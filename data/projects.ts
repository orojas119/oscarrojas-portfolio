...
export const projects: Project[] = [
      ...
      comparables: [
        {
          ...
          vendor: "AllVoices",
          annualCost: 3300,
          pricingBasis: "$275/month starting price for organizations under 100 employees, published on AllVoices' own pricing page",
          sourceNote: "allvoices.co/pricing, checked Sept 2026. Real quotes scale with employee count and admin-user count from there, so this is their entry-level published rate, not a quote for ILS specifically.",
        },
      ],
      annualSavings: 3300,
    },
  ...
  {
    slug: "royal-courier-digest",
    title: "Royal Courier Digest Builder",
    tagline: "Turns a list of Royal Courier article links into a branded, ready-to-send newsletter, replacing a raw stack of Outlook link previews down one column.",
    description:
    ...
    techStack: ["Vite", "React", "TypeScript", "Azure Functions", "Sharp", "Azure Static Web Apps"],
    features: [
    ...
    featured: false,
    year: "2026",
    discipline: "INTERNAL TOOLS | COMMUNICATIONS",
    accentColor: "#0284C7",
    category: "Internal Tools",
    deployment: "private",
    organization: "Immaculata-La Salle High School",
    ...
    impact: {
      ...
      before: "Building an edition meant stacking raw Outlook link previews down a single column by hand, with no consistent branding, no crest, and no control over how images cropped once pasted into an email.",
      after: "The team pastes article links in, edits titles and ordering, and gets back a branded two-column edition with the ILS crest, ready to paste straight into Outlook or download as a standalone file.",
      comparables: [
        {
          product: "Smore (Pro)",
          vendor: "Smore Inc.",
          annualCost: 179,
          pricingBasis: "$179/year, Pro tier (custom branding/logo, up to 15,000 monthly sends), published pricing, single-user",
          sourceNote: "smore.com/pricing, Sept 2026. Smore's tiers are single-user; true multi-user parity for a full media team would require its custom-quote Teams plan, which has no public price.",
        },
      ],
      annualSavings: 179,
    },
